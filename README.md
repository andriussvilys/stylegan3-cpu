# WARNING
**Using CPUs are ⪅100 times slower than GPUs.** (tested on Nvidia T4 & Intel i7-1165G7 @2.80GHz)
...
* Python libraries: see [environment-gpu.yml](./environment-gpu.yml) for exact library dependencies.  You can use the following commands with Miniconda3 to create and activate your StyleGAN3 Python environment:
